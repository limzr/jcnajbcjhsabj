...
public class EditTaskActivity extends ActionBarActivity implements TaskFormFragment.OnFragmentInteractionListener{
    ...
    public void saveTask(String name,String date, String time, String notification){
        ...
        long newRowId = mDbHelper.updateTask(name, date, time, notification, db);
        db.close();
